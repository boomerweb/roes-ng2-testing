...
var HeroDetailComponent = (function () {
    function HeroDetailComponent(heroDetailService, route, router, location) {
    ...
    HeroDetailComponent.prototype.save = function () {
        var _this = this;
        this.heroDetailService.saveHero(this.hero).then(function () { return _this.goBack(); });
    };
    ...
    HeroDetailComponent = __decorate([
        ...
        __metadata('design:paramtypes', [hero_detail_service_1.HeroDetailService, router_1.ActivatedRoute, router_1.Router, common_1.Location])
    ], HeroDetailComponent);
